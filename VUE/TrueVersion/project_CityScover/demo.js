/**
 * This function allows to convert an address into coordinates
 * @param {H.service.Platform} platform 
 */
function geocode(platform, startPosition, endPosition) {
...
function calculateRouteFromAtoB(platform) {
  var router = platform.getRoutingService(null, 8),
      routeRequestParams = {
        routingMode: 'fast',
        transportMode: 'car',
        origin: '48.6328318,2.3394856', // Brandenburg Gate
        destination: '48.82093811035156,2.2620890140533447', // Friedrichstraße Railway Station
...
var platform = new H.service.Platform({
  apikey: 'y8tz0JuFJhqN_w7u_ABIgzBx2448Hp1Z_VhFDF9Oioc'
});
...
buttonRoute.addEventListener('click', function(e){
  ...
  geocode(platform, startPoint.value, endPoint.value);
});
// calculateRouteFromAtoB(platform);
